...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/about.vue?vue&type=template&id=25bebdc4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"bg-gray-100"},[_vm._ssrNode("<h2 class=\"text-3xl text-blue-800 font-bold uppercase text-center mb-2\">A Propos</h2> <div class=\"mx-auto\"><div class=\"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 p-8\"><div class=\"bg-white rounded-lg shadow-lg p-6\"><h2 class=\"text-xl font-semibold mb-4 text-justify text-blue-800 text-2xl\">Notre Histoire</h2> <p class=\"text-gray-700 mb-4 text-xl text-justify\">\n\n          KENAYA FINANCES est une société d'intermédiation financière fondée à Brazzaville le 19 mars 2019. Nous\n          travaillons en partenariat avec plusieurs institutions financières pour proposer une gamme diversifiée de\n          produits financiers à nos clients.\n\n        </p> <p class=\"text-gray-700 mb-4 text-xl text-justify\">\n          Parmi ces produits, nous commercialisons notamment des services de transfert d'argent tels que MONEY GRAM et\n          RIA, des abonnements à CANAL+, des cartes prépayées UBA et PRESF, ainsi que des services de paiement mobile\n          tels que MOBILE MONEY et AIRTEL MONEY\n\n        </p> <a href=\"#\" class=\"text-blue-600 hover:text-blue-800 font-semibold\">Learn more</a></div> <div><img"+(_vm._ssrAttr("src",__webpack_require__(40)))+" alt=\"Image\" class=\"w-full rounded-lg shadow-lg\"></div></div> <div class=\"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 mt-12 bg-blue-800 p-8\"><div><img"+(_vm._ssrAttr("src",__webpack_require__(41)))+" alt=\"Image\" class=\"w-full rounded-lg shadow-lg\"></div> <div class=\"bg-white rounded-lg shadow-lg pt-8 p-6\"><h2 class=\"text-xl font-semibold mb-4 pt-8 text-blue-800 text-2xl\">Notre Mission et Valeurs</h2> <p class=\"text-gray-700 mb-4 text-xl text-justify\">\n\n\n          Our mission is to provide fast, reliable, and secure money transfer services to our clients, while\n          delivering exceptional customer service and support. <br>\n\n          We are guided by the following core values: <br>\n\n          Integrity\n          Professionalism\n          Accountability\n          Innovation\n\n\n        </p> <a href=\"#\" class=\"text-blue-600 hover:text-blue-800 font-semibold\">Learn more</a></div></div> <div class=\"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-8 mt-8 p-8\"><div class=\"bg-white rounded-lg shadow-lg p-6 pt-8\"><h2 class=\"text-xl font-semibold mb-4 pt-8 text-blue-800 text-2xl\">Notre Services</h2> <p class=\"text-gray-700 mb-4 text-xl text-justify\">\n          We offer a range of money transfer services to suit the needs of our clients, including:\n\n          Domestic money transfers\n          International money transfers\n          Online money transfers\n          Mobile money transfers\n          Bill payments\n          Our services are fast, reliable, and secure, and we use the latest technology to ensure that your money is\n          transferred quickly and safely.\n\n\n        </p> <a href=\"#\" class=\"text-blue-600 hover:text-blue-800 font-semibold\">Learn more</a></div> <div><img"+(_vm._ssrAttr("src",__webpack_require__(42)))+" alt=\"Image\" class=\"w-full rounded-lg shadow-lg\"></div></div></div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/about.vue?vue&type=template&id=25bebdc4&
