<template>
  <div class="scrollable-container">
    ...
    <div class="mx-auto flex flex-col px-8 sm:flex-row justify-between py-16 gap-8">
      ...
      <div class="">
        <img src="../assets/img/diplomate.jpg" alt="Image" class="w-full rounded-lg shadow-lg">
      </div>
