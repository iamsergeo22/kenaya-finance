<template>
  <div class="font-poppins">
    ...
    <div class="relative w-full h-full flex flex-col justify-center items-center h-full bg-opacity-60">
      <h1 class="lg:text-4xl sm:text-3xl font-bold text-white">Notre Equipe</h1>
    </div>
  </div> -->
    ...
    <section class="bg-gray-300 py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
          ...
          <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-color font-bold sm:text-4xl">
            Notre Equipe
          </p>
        </div>
          ...
          <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <img class="mx-auto h-48 w-48 rounded-full" src="../assets/img/moko.jpeg" alt="">
                <h3 class="mt-6 text-center font-bold text-xl text-color">
                  Patrick Moko
                </h3>
                <div class="mt-2 text-center text-sm leading-5 text-gray-600">
                  <p>Lead Developer</p>
                  <p class="mt-1 text-black text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <img class="mx-auto h-48 w-48 rounded-full" src="../assets/img/christ.jpeg" alt="">
                <h3 class="mt-6 text-center font-bold text-xl text-color">
                  Magnalet Christ
                </h3>
                <div class="mt-2 text-center text-sm leading-5 text-gray-600">
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
              <div class="px-4 py-5 sm:p-6">
                <img class="mx-auto h-48 w-48 rounded-full" src="../assets/img/juldo.jpeg" alt="">
                <h3 class="mt-6 text-center font-bold text-xl text-color">
                  Mapola Juldo
                </h3>
                <div class="mt-2 text-center text-sm leading-5 text-gray-600">
