<template>
    <div class="font-poppins">
        ...
        <div class="bg-gray-200 shadow-xl lg:rounded-md lg:mx-12 transform -translate-y-40 bottom-0 left-0 px-8 py-12">
            <div class="lg:flex lg:flex-row sm:flex sm:flex-col lg:justify-betwen lg:gap-8">
                    ...
                    <form action="#" class="mb-8">
                        ...
                        <div class="flex justify-start w-full">
                            <input type="submit" value="Envoyer"
                                class="block bg-color hover:bg-blue-800 text-white text-sm font-semibold tracking-wide uppercase shadow rounded cursor-pointer px-6 py-3">
                        </div>
                    </form>
                </div>
                ...
                <div>
                    <div class="bg-gray-100 rounded-lg shadow-lg px-4 pt-4 items-center">
                        <div class="flex flex-col gap-3 pb-4">
                            <h1 class="font-bold text-2xl text-color">Contact details:</h1>

                            <span class="flex gap-1 text-md items-center">
                                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
                                    class="w-4 lg:mr-4" role="img" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 576 512">
                            ...
                            <span class="flex gap-1 text-md items-center">
                                ...
                                </svg> +242 065918117</span>

                            <span class="flex gap-1 text-md items-center">
                                <svg fill="#000000" viewBox="0 0 32 32" class="w-8 lg:mr-2" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>time</title> <path d="M11.188 27.188c-6.188 0-11.188-5-11.188-11.188s5-11.219 11.188-11.219 11.219 5.031 11.219 11.219-5.031 11.188-11.219 11.188zM11.188 7.563c-4.625 0-8.375 3.813-8.375 8.438s3.75 8.375 8.375 8.375 8.438-3.75 8.438-8.375-3.813-8.438-8.438-8.438zM14.219 20.281l-3.969-2.906c-0.281-0.219-0.563-0.688-0.563-1.063v-6.344c0-0.344 0.313-0.625 0.688-0.625h1.313c0.344 0 0.625 0.281 0.625 0.625v5c0 0.375 0.281 0.844 0.563 1.063l2.906 2.094c0.281 0.219 0.344 0.656 0.125 0.938l-0.781 1.063c-0.219 0.281-0.625 0.344-0.906 0.156z"></path> </g></svg>
                                Monday - Friday: 9am - 5pm, Saturday: 10am - 2pm, Sunday: Closed</span>
...
<style scoped>
    .bg-image {
        background-image: url(../assets/img/image/331426255_1411753576305242_272167460667299199_n.jpg);
        background-size: top;
