    ...
    <footer class="bg-color text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:s.tassiga@alustudent.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/STassiga" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/__iamsergeo/" target="_blank" class="text-white hover:text-gray-400">
